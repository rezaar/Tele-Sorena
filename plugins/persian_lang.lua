...
local function run(msg, matches)
    ...
    set_text(LANG, 'muteAll', 'توانایی صحبت از همه گرفته شد.')
        ...
        set_text(LANG, 'rules:1', '#rules : نشان قوانین گروه')

        if matches[1] == 'install' then
            return 'ℹ️زبان شیرین پارسی با موفقیت بر روی ربات شما نصب شد'
        elseif matches[1] == 'update' then
            return 'ℹ️زبان شیرین پارسی با موفقیت بروزرسانی شد.
        end
    else
